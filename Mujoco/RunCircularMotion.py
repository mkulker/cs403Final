  ...
  while not simulate.exitrequest:
    ...
    if reload and loader is not None:
      ...
      if result is not None:
        m, d = result
        # ctrl = JPosCtrl.JPosCtrl(m, d)
        ctrl = CircularMotion.CircularMotionCtrl(m, d)
        # ctrl = DrillMotion.DrillMotionCtrl(m, d)
...
if __name__ == '__main__':
  ...
  def main(argv) -> None:
    launch_from_path(dir_path + "/Robot/miniArmCircle.xml")
